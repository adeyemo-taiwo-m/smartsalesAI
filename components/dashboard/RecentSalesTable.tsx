...
export function RecentSalesTable() {
  ...
  return (
    <div className="bg-dark-card rounded-xl border border-slate-700/50 shadow-card overflow-hidden group hover:border-slate-600 transition-colors">
      {/* Header */}
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead>
            <tr className="border-b border-slate-700/50 bg-dark/30 select-none text-[10px] font-semibold text-slate-400 uppercase tracking-wider">
            ...
            {recentSales.map((sale) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Product */}
                  <td className="px-5 py-3 text-slate-300 truncate max-w-[130px]">
                    {sale.product}
                  </td>
                  {/* Channel icon badge */}
