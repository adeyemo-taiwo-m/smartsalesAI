        ...
        <div>
          ...
          <div className="flex h-16 items-center px-6 border-b border-dark-border">
            ...
            >
              ...
              {sidebarOpen && (
                <span className="text-lg font-bold bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent tracking-tight">
                  SmartSales AI
                </span>
              )}
            </Link>
              ...
              return (
                ...
                >
                  ...
                  {isActive && !sidebarOpen && (
                    <div className="absolute right-1 w-1 h-6 bg-blue-500 rounded-full" />
                  )}
                </Link>
              );
            })}
            ...
            {sidebarOpen && (
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  <span className="text-[10px] font-bold bg-purple-500/10 text-purple-400 border border-purple-500/20 px-1.5 py-0.5 rounded-full uppercase tracking-wider scale-90 origin-left">
                    Pro Plan
                  </span>
                </div>
              </div>
